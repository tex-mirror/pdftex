...
const_string ALEPHHELP[] = {
    ...
    "",
    "-afmt=FMTNAME           use FMTNAME instead of program name or a %& line",
...
const_string PDFXTEXHELP[] = {
    ...
    "  If the first line of TEXNAME is %&FMT, and FMT is an existing .fmt file,",
    "  use it.  Else use `NAME.xfmt', where NAME is the program invocation name,",
    "  most commonly `pdfetex'.",
    "",
    "  Alternatively, if the first non-option argument begins with a backslash,",
    "  interpret all non-option arguments as a line of pdfeTeX input.",
    ...
    "                          list: cr display hbox math par parend vbox",
    "-translate-file=TCXNAME use the TCX file TCXNAME",
    "-xfmt=FMTNAM            use FMTNAME instead of program name or a %& line",
    "-help                   display this help and exit",
    "-version                output version information and exit",
    NULL
};
