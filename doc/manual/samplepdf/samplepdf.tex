...
%*****************************************************
% some stuff added recently, while testing 1.40.8-beta
%_____________________________________________________

\vfil\eject

%% truetype font
\pdfmapline{=tahoma-texnansi <tahoma.ttf <q-texnansi-uni.enc}
\font\f=tahoma-texnansi
\leftline{\f This text is typeset using Tahoma}

%% pdf inclusion: use encguide.pdf
\newcount\countA
\newcount\countB

\def\includePDF#1{
    \pdfximage{#1}%
    \countA=\pdflastximagepages
    \countB=1
    \noindent
    \loop
        \pdfximage width 3cm page \the\countB {#1}%
        \hbox{\pdfrefximage\pdflastximage}\space
    \ifnum\countB<\countA
        \advance\countB 1
    \repeat
}

\includePDF{encguide.pdf}
\vfil\eject
\includePDF{microtype.pdf}
